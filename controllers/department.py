...
@department_router.post("", response_model=DepartmentSchemaOut, dependencies=[Security(IsAuthenticated())])
...
@department_router.put("", response_model=DepartmentSchemaOut, dependencies=[Security(IsAuthenticated())])
